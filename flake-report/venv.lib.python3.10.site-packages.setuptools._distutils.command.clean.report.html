...
<html>
   <head>
      <title>flake8 violations: venv/lib/python3.10/site-packages/setuptools/_distutils/command/clean.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.10.site-packages.setuptools._distutils.command.clean.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.10.site-packages.setuptools._distutils.command.clean.source.html#l12">
